...
local fadeout = cmd(stoptweening;diffusealpha,1;sleep,0.9;linear,0.15;diffusealpha,0);
local TNSFrames = {
	TapNoteScore_W1 = 0;
	TapNoteScore_W2 = 1;
	TapNoteScore_W3 = 2;
...
local t = Def.ActorFrame{
	...
	LoadActor("Judgment")..{
		...
		--[[
			...
			local scores = {
				"current possible: "..PSS:GetCurrentPossibleDancePoints(),
				"current total: "..PSS:GetActualDancePoints(),
				"current percentage: "..(PSS:GetActualDancePoints()/PSS:GetCurrentPossibleDancePoints()),
			}
